...
if (uiLanguage !== undefined) {
  // Since monaco-editor 0.56, the language bundle is a plain script that
  // sets the NLS globals; it is no longer an AMD module and must not be
  // requested through `require`.
  const script = document.createElement('script')
  script.src = jsUrl + '/nls/lang/' + uiLanguage + '.js'
  script.onload = loadEditor
  script.onerror = loadEditor
